...
class __TwigTemplate_6fb75f9d0125dab1345d6585d4b59836 extends Template
{
    ...
    ";
          ...
          ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["sub_option"]) {
                        ...
                        yield "\"";
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar((((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["sub_option"], "selected", [], "any", false, false, true, 21)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (" selected=\"selected\"") : ("")));
                        yield ">";
...
$context["option"], "type", [], "any", false, false, true, 24) == "option")) {
                    ...
                    yield "\"";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar((((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["option"], "selected", [], "any", false, false, true, 25)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (" selected=\"selected\"") : ("")));
                    yield ">";
...
";
    ...
    {
        return new Source("", "core/modules/system/templates/select.html.twig", "/var/www/html/ESIM-content-drupal10-9dec/core/modules/system/templates/select.html.twig");
    }
