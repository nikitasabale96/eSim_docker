...
/* themes/contrib/nava/templates/navigation/links--node.html.twig */
class __TwigTemplate_15841f013e27e76c8878d97675383cb2 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = ($context["links"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                yield ">";
                // line 46
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "link", [], "any", false, false, true, 46)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 47
...
$context["item"], "text_attributes", [], "any", false, false, true, 48)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 49
                    yield "<span";
    ...
    {
        return "themes/contrib/nava/templates/navigation/links--node.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/nava/templates/navigation/links--node.html.twig", "/var/www/html/ESIM-content-drupal10-9dec/themes/contrib/nava/templates/navigation/links--node.html.twig");
    }
