...
// var_dump($proposal_data);die;
    ...
    $form['existing_depfile']['dep_lab_title'] = [
      '#type' => 'select',
      '#title' => t('Title of the Lab'),
      '#options' => \Drupal::service("lab_migration_global")->_list_of_lab_titles(),
    ];

    list($files_options, $files_options_class) = \Drupal::service("lab_migration_global")->_list_of_dependency_files();
  ...
  'Upload New Dependency Files',
  Url::fromUri('internal:/lab_migration/code/upload_dep')
)->toString(),
    ];
