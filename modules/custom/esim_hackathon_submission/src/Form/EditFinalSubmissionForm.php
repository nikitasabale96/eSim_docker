...
/**
 * @file
 * Contains \Drupal\hackathon_submission\Form\EditFinalSubmissionForm.
 */
...
class EditFinalSubmissionForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'edit_final_submission_form';
  }
  ...
  public function buildForm(array $form, \Drupal\Core\Form\FormStateInterface $form_state, $no_js_use = NULL) {
    ...
    $query_bib_ref = \Drupal::database()->select('hackathon_final_submission_bib_references');
